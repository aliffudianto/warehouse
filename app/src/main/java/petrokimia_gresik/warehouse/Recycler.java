...
public class Recycler extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = "http://192.168.43.16:8080/android_login_api/Api.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            DataAdapter adapter = new DataAdapter(Recycler.this, productList);
